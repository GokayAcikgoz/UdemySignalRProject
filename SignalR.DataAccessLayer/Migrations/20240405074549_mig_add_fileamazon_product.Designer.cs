...
namespace SignalR.DataAccessLayer.Migrations
{
    ...
    [Migration("20240405074549_mig_add_fileamazon_product")]
    partial class mig_add_fileamazon_product
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SignalR.EntityLayer.Entities.FileAmazon", b =>
                {
                    b.Property<int>("FileAmazonID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("FileAmazonID"), 1L, 1);
                    ...
                    b.HasKey("FileAmazonID");

                    b.ToTable("FileAmazons");
                });
            ...
            modelBuilder.Entity("SignalR.EntityLayer.Entities.Product", b =>
                {
                    ...
                    b.HasIndex("FileAmazonID")
                        .IsUnique()
                        .HasFilter("[FileAmazonID] IS NOT NULL");
            ...
            modelBuilder.Entity("SignalR.EntityLayer.Entities.Product", b =>
                {
                    ...
                    b.HasOne("SignalR.EntityLayer.Entities.FileAmazon", "FileAmazon")
                        .WithOne("Product")
                        .HasForeignKey("SignalR.EntityLayer.Entities.Product", "FileAmazonID");

                    b.Navigation("Category");

                    b.Navigation("FileAmazon");
                });
